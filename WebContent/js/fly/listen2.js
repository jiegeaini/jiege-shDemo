...
var idC = loc.substr(n2+1, n1-n2);//从=号后面的内容
...
$.ajax({
	...
	success: function(data) {
		$("#musicname").css({
			...
			var html = '<li class="list-group-item mmid"><span style="display:none">'+data.id+'</span>'+
                '<div class="clear text-ellipsis">'+
                '<span>'+data.name+'</span></div></li>';
			$("#musicname").append(html);
